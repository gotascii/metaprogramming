...
* If we ever want to figure out where a method is defined we just need to answer the question "What is self set to?" and then use "Go to the right." to determine in what class the method is defined in.
